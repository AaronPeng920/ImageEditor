...
class EditPipeline(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin):
    ...
    def __call__(
        ...
        print("[INFO]timesteps: ", timesteps, "length: ", len(timesteps))
        print("[INFO]num_inference_steps: ", num_inference_steps)
        ...
        print("[INFO]source_latents.shape & mutual_latents.shape: ", source_latents.shape, mutual_latents.shape)
